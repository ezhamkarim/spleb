...
import 'package:spleb/src/widget/custom_textfield.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  CustomTextField(controller: emailTextController, hintText: 'Email', isObscure: false, isEnabled: true),
                  CustomTextField(controller: passwordTextController, hintText: 'Password', isObscure: true, isEnabled: true)
                ],
              ),
